...
Once your connection checks out, paste a real PR URL after `@bitbucket` in the chat box, e.g. `@bitbucket https://bitbucket.mycompany.com/projects/PROJ/repos/myrepo/pull-requests/42`. This step completes once a review actually finishes successfully.
